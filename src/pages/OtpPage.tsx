...
export function OtpPage() {
  ...
  return (
    ...
    >
      ...
      <main className="flex-1 flex flex-col px-5 pt-10 pb-10 mobile-ls:pt-4 mobile-ls:pb-32">
        {/* ── Headline ── */}
        <section className="mb-10 shrink-0 mobile-ls:mb-4">
          <h2 className="font-headline font-extrabold text-4xl mobile-ls:text-2xl text-on-surface mb-3 mobile-ls:mb-1 tracking-tight leading-tight">
            Проверим почту
          </h2>
