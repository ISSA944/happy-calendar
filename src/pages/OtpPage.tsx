...
const OtpBox = memo(function OtpBox({
  ...
  return (
    <div
      className={`flex-1 min-w-0 max-w-[72px] aspect-square bg-surface-container-lowest rounded-[24px] flex items-center justify-center shadow-sm transition-colors duration-150 relative overflow-hidden ${
