  ...
  const content = (
    <div className="fixed inset-0 z-[100]">
      ...
      <motion.div
        ...
        className="absolute bottom-0 left-0 right-0 mx-auto w-full max-w-[430px] overflow-hidden rounded-t-[28px] bg-surface-container-lowest shadow-[0_-8px_32px_rgba(0,0,0,0.12)]"
        style={{
