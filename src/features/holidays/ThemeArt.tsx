 ...
 * Для праздников без установленного готового WebP-пака это осмысленный фолбэк:
 * мягкий градиент темы + декоративный «боке» + узнаваемый мотив (стиль Zen-Emerald).
 * Установленные паки подставляются в `imageUrl`, а ThemeArt остаётся запасным
 * вариантом. 19 тем 1:1 с THEME_GRADIENTS / backend themes.constant.ts.
 */
